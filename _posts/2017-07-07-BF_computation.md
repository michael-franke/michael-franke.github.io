...
{% highlight text %}
## [1] "Approximate BF in favor of complex model (Savage-Dickey): 4.283"
{% endhighlight %}
...
{% highlight text %}
## [1] "Approximate BF in favor of complex model (naive MC): 4.344"
{% endhighlight %}
...
{% highlight text %}
## [1] "BF in favor of complex model (transcendental): 5.349"
{% endhighlight %}
...
{% highlight text %}
## [1] "BF in favor of complex model (supermodels): 3.976"
{% endhighlight %}
