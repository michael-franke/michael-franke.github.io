...
require('dplyr')
require('ggplot2')
load("//Users/micha/Desktop/data/svn/ProComPrag/teachings/KogWis_bda_2016/slides/results_binomial_comparison.Rdata")
...
myplot = ggplot(data = false_rejections, aes(x = N, y = frequency, fill = approach)) + geom_bar(stat = "identity", position = "dodge") + ggtitle("probability of false rejections of true null") + ylab("frequency") + xlab("sample size N")
show(myplot)
```
