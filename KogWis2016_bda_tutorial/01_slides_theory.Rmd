...
- <span style = "color:firebrick">negative binomial distribution</span> gives the probability of observing $k$ successes:
...
## another $p$-value for the same data set
...
For distribution $P(x)$ over $X$, the <span style = "color:firebrick">95% credible interval</span> is a subset $Y \subseteq X$ such that:
